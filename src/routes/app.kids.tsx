...
const MISSIONS = [
  {
    n: "01",
    t: "The Empathy Lab",
    d: "Help two characters understand each other.",
    time: "10 min",
    q: "EQ",
  },
  { n: "02", t: "Pattern Forest", d: "Find the rule hiding in the trees.", time: "8 min", q: "IQ" },
  {
    n: "03",
    t: "Bridge Builders",
    d: "Work with a partner to cross the river.",
    time: "12 min",
    q: "SQ",
  },
  {
    n: "04",
    t: "Storm Camp",
    d: "Decide what to do when the plan changes.",
    time: "9 min",
    q: "AQ",
  },
];
      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          <div className="grid grid-cols-12 gap-6 items-center">
            <div className="col-span-12 lg:col-span-7">
              ...
              <p className="mt-5 text-muted-foreground max-w-md text-[14px] leading-relaxed">
                A story where every choice trains a real skill — empathy, reasoning, courage, or
                teamwork. Read, decide, and earn a node on your map.
              </p>
        ...
        <div className="col-span-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border border border-border">
            {MISSIONS.map((m) => (
              <button
                key={m.n}
                className="bg-background p-7 text-left group transition-colors hover:bg-[var(--surface)]"
              >
                ...
                <div className="text-[11px] font-mono tracking-wider text-muted-foreground">
                  {m.time.toUpperCase()}
                </div>
              </button>
            ))}
        ...
        <div className="col-span-12 lg:col-span-8 border border-border p-8">
          ...
          <div className="flex items-center justify-between gap-3">
            {["Start", "Empathy", "Logic", "Teamwork", "Courage", "Curiosity", "Mastery"].map(
              (step, i) => (
                <div key={step} className="flex-1 flex flex-col items-center text-center">
                  <div
                    className={`w-10 h-10 border flex items-center justify-center rounded-full ${i <= 2 ? "bg-[var(--gold)] border-[var(--gold)] text-background" : "border-[var(--border-strong)] text-muted-foreground"}`}
                  >
                    {i <= 2 ? <Star className="w-4 h-4" /> : i + 1}
                  </div>
                  <div className="text-[10px] font-mono tracking-wider mt-3 text-muted-foreground">
                    {step.toUpperCase()}
                  </div>
                </div>
              ),
        ...
        <div className="col-span-12 lg:col-span-4 border border-border p-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[Compass, Star, Rocket].map((Icon, i) => (
              <div
                key={i}
                className="aspect-square border border-[var(--border-strong)] flex flex-col items-center justify-center gap-2"
              >
