...
export const DIAGRAM_QUESTIONS: DiagramQuestion[] = [
  {
    id: "DQ1",
    pillar: "IQ",
  ...
  },
  {
    ...
    answer: 2,
    explanation:
      "Each row: column 1 is the base, column 2 = base², column 3 = base³. Row 3: 4, 16, 4³=64.",
  },
  {
    id: "DQ3",
    pillar: "IQ",
    ...
    answer: 2,
    explanation:
      "After 3 rotations of 90° clockwise (total 270°), the dot moves from top-right → bottom-right → bottom-left → top-left.",
  },
  {
    id: "DQ4",
    pillar: "IQ",
    ...
    answer: 1,
    explanation: "The overlapping region shows some doctors are also scientists, but not all.",
  },
  {
    id: "DQ5",
    pillar: "IQ",
    ...
    answer: 0,
    explanation:
      "Thursday = 20 units. 25% higher = 20 × 1.25 = 25. Monday = 40, which is 100% higher. Actually none match exactly.",
  },
  {
    id: "DQ6",
    pillar: "IQ",
    ...
    answer: 3,
    explanation:
      "In a cross-shaped net, the top face (▲) is opposite the bottom face (◆). The center (■) is opposite the diamond (◆).",
  },
  {
    id: "DQ7",
    pillar: "IQ",
    ...
    options: ["d", "p", "q", "b"],
    answer: 0,
    explanation: 'A vertical mirror reflection of "b" produces "d".',
  },
  {
    id: "DQ8",
    pillar: "IQ",
    ...
    answer: 0,
    explanation: "A bird lives in a nest. A fish lives in water. The analogy is about habitat.",
  },
  {
    id: "DQ9",
    pillar: "IQ",
    ...
    answer: 1,
    explanation:
      "At 3:00, hour hand points to 3 (90° from 12), minute hand points to 12 (0°). Difference is 90°.",
  },
  {
    id: "DQ10",
    pillar: "IQ",
    ...
    answer: 2,
    explanation: "All other shapes are circles. The rectangle is the odd one out.",
  },
];

export function getRandomDiagramQuestions(count = 5): DiagramQuestion[] {
